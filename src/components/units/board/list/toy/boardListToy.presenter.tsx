import * as s from "./boardListToy.styles";
...
export default function BoardListToyUI(props: BoardListUIProps) {
  return (
    <s.Wrapper>
      {props.isPc && (
        <s.CategoryWrapper>
          ...
          <s.CategoryToy onClick={props.onClickMoveToToy}>Toy</s.CategoryToy>
        </s.CategoryWrapper>
      )}
