                ...
                props?.runnerData?.map((el) => (
                  ...
                  >
                    {el.board?.image === "" ? (
                      ...
                      <s.ActiveImg
                        src={`https://s3.brian-hong.tech/openrun/${el.board?.image}`}
                      />
                    )}
                    <s.ActiveTextWrapper>
                      <s.ActiveText color="#333" weight="700" size="0.8rem">
                  ...
                  <s.ChatProfileImg
                    src={
                      el?.seller?.profileImg
                        ? `https://s3.brian-hong.tech/openrun/${el.seller.profileImg}`
                        : "/img/profile.png"
                    }
                  />
                  ...
                  <s.ChatProfileImg
                    src={
                      el?.runner?.profileImg
                        ? `https://s3.brian-hong.tech/openrun/${el.runner.profileImg}`
                        : "/img/profile.png"
                    }
                  />
